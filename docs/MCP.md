...
| `ezra_render_candidate` | `candidate_id`, `spec?` | Job (spec: aspect, layout, caption_theme, punch_in, remove_silence, hook_overlay, protect_graphics, yield_to_source_captions, …) |
